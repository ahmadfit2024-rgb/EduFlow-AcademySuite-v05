...
# -----------------------------------------------------------------
# MIGRATION: Completely rebuilt the admin interface for the new
# relational models.
# - Lessons are now managed as an inline component within the Course admin.
# - LearningPathModules are managed inline within the LearningPath admin.
# - Registered the new Question and Answer models for direct management.
# =================================================================
